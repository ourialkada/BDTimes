...
function Test() {
	...
	today = date;
	var sunday = new Date(today.setDate(today.getDate() - endofweek));
	today = date;
	var friday = new Date(today.setDate(today.getDate() + endofweek - 1));

	var _require = require('@hebcal/core'),
	    GeoLocation = _require.GeoLocation,
	    Zmanim = _require.Zmanim;

	var latitude = 34.171210;
	var longitude = -118.539940;
	var tzid = 'America/Los_Angeles';
	var gloc = new GeoLocation(null, latitude, longitude, 0, tzid);
	var zmanim = new Zmanim(gloc, today3, false);
